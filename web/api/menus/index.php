...
/**
 * Menus API
 * Handles menu and dish management
 */
...
function handleCreateMenu($conn) {
    try {
        ...
        // Validate category
        $validCategories = ['beef', 'pork', 'chicken', 'pancit', 'other'];
        if (!in_array($category, $validCategories)) {
            $category = 'other';
        }
        
        // Insert menu item
        $query = "INSERT INTO menu (DishName, Description, ImageURL, Category, MenuPrice) 
                  VALUES (:dishName, :description, :imageURL, :category, :menuPrice)";
...
if (isset($data['image_url'])) {
    ...
    $params[':imageURL'] = sanitizeInput($data['image_url']);
}
